...
{
    public class CompAbilityEffect_EnergyBlast : CompAbilityEffect
    {
        public new CompProperties_EnergyBlast Props => (CompProperties_EnergyBlast)props;
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            else
            {
                ...
                {
                    GenExplosion.DoExplosion(target.Cell, caster.Map, Radius, Props.damageDef, caster, (int)Math.Round(Props.damageFactor * ConvertedEnergy),
        ...
        {
            if (!SHGUtilities.HasRelatedGene(parent.pawn, Props.mainResourceGene))
            {
