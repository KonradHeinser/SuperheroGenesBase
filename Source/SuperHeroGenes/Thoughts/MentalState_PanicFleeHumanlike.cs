...
{
    public class MentalState_PanicFleeHumanlike : MentalState
    {
        ...
        public override void MentalStateTick()
        {
            ...
            if (pawn.IsHashIntervalTick(30))
                if (lastSeenTick < 0 || NearbyHumanlike())
        ...
        private bool NearbyHumanlike()
        {
            if (!pawn.Spawned) return false;
            return pawn.Map.mapPawns.AllPawnsSpawned.Where((arg) => arg.Spawned && 
                arg.RaceProps.Humanlike && !arg.DeadOrDowned && arg.Awake() && 
